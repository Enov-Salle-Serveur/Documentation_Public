...
1. Une fois connecté sur le portail Nebula, cliquez sur votre nom d'utilisateur ou l'icône de profil en haut à droite.
2. Dans le menu déroulant, sélectionnez **Settings** (Paramètres du compte).
